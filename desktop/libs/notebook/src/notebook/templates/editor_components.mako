  ...
  <ul data-bind="foreach: variables" class="unstyled inline">
    <li>
      <div class="input-prepend margin-top-10">
        ...
        <input class="input-medium" type="text" data-bind="value: value, attr: { placeholder: defaultValue() || '${ _ko('Variable value') }' }, valueUpdate: 'afterkeydown', autogrowInput: { minWidth: 150, maxWidth: 270, comfortZone: 15 }, event: { 
        'keydown': function (context, e) {
          var key = (e.key || '').toLowerCase();
          e.metaKey = $parent.onVariableKeyPressState.metaKey = $parent.onVariableKeyPressState.metaKey || key === 'meta';
          return $parent.onVariableKeyPress($parent, context, e);
        },
        'keyup': function (context, e) {
          var key = (e.key || '').toLowerCase();
          $parent.onVariableKeyPressState.metaKey = $parent.onVariableKeyPressState.metaKey && key !== 'meta';
        },
